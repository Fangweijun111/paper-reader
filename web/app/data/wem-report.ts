...
export const wemReportMarkdown = String.raw`# 《World-Ego Modeling for Long-Horizon Evolution in Hybrid Embodied Tasks》中文精读报告
...
export const wemEvidenceTargets: Record<string, string> = {
  "Figure 3": "wem-framework-figure",
  "Figure 4": "wem-model-figure",
  "Table 1": "wem-table-boundary",
  "Table 2": "wem-table-main",
  "Table 3": "wem-table-main",
  "Table 5": "wem-table-ablation",
  "Eq. 1": "wem-equation-1",
  "§3.1": "wem-formulation-input",
  "§4.2": "wem-cpmoe",
  "Appendix B": "wem-metrics-continuous",
  "Appendix C": "wem-variant-motion",
  "Appendix D": "wem-eval-protocol",
};
